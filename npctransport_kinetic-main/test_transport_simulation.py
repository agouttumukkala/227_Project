    ...
    def test_simulation(self):
        ...
        expected_stats = \
            {'time_sec': array([1.000e-03, 2.501e+00, 5.001e+00, 7.501e+00]),
             'complexL_NPC_N_import': array([0., 26716.61622277, 27661.69858981, 26739.33829553]),
             'complexL_NPC_C_import': array([0., 26841.59293957, 27778.30377937, 26846.93361103]),
             'complexU_NPC_N_import': array([0., 0., 0., 0.]), 'complexU_NPC_C_import': array([0., 0., 0., 0.]),
             'complexL_NPC_N_export': array([0., 8730.19487584, 14009.35264709, 17086.61559209]),
             'complexL_NPC_C_export': array([0., 8706.54011213, 13978.39393505, 17050.47109701]),
             'complexU_NPC_N_export': array([0., 0., 0., 0.]), 'complexU_NPC_C_export': array([0., 0., 0., 0.]),
             'complexL_C': array([1.68164350e+02, 2.10961044e+05, 3.48534180e+05, 4.39349880e+05]),
             'freeL_C': array([1681475.33465, 1323004.67669619, 1062099.67098618,
                               871297.61991343]), 'complexU_C': array([0., 0., 0., 0.]),
             'freeU_C': array([0., 0., 0., 0.]), 'complexL_N': array([0., 6292.36410467, 14737.13433589, 22944.203708]),
             'freeL_N': array([1.00000000e-03, 7.03904708e+04, 1.72844766e+05, 2.60328437e+05]),
             'complexU_N': array([0., 0., 0., 0.]), 'freeU_N': array([0., 0., 0., 0.]),
             'nuclear_importL_per_sec': array([7.63484083e-06, 5.09284127e-01, 5.32553385e-01, 5.31471750e-01]),
             'nuclear_exportL_per_sec': array([0., 0.11357389, 0.07453442, 0.06020191]),
             'nuclear_importU_per_sec': array([0., 0., 0., 0.]), 'nuclear_exportU_per_sec': array([0., 0., 0., 0.]),
             'GTP_N': array([362107.91342657, 334681.57208627, 292146.25547386, 269547.11807043]),
             'GTP_C': array([235.40545455, 199.01188995, 197.02947705, 194.66540413]),
             'GDP_N': array([434.52225287, 723.40299972, 723.40495259, 723.40731827]),
             'GDP_C': array([362270.95886601, 389444.81302406, 431982.1100965, 454583.60920717])}
        ts = transport_simulation.TransportSimulation()
